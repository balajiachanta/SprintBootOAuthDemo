...
public class UserPasswordConverter {
	...
	public boolean passwordEncryptor(String password, String username) throws NoSuchAlgorithmException
	{
		...
		if(rawPasswordEncoded != null)
		{
			...
			encode = new EncodeDetails(encodedSalt, username, value, encodedPassword);
